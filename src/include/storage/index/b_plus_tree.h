...
class BPlusTree {
 ...
 public:
  ...
  Page *FindLeafPage(const KeyType &key, bool leftMost = false, Operation op = Operation::READONLY, Transaction *transaction = nullptr);
 ...
 private:
  ...
  // unlock 和 unpin 事务中经过所有的parent page
  ...
  // 保护root page id不被改变
  std::mutex mutex_;
  /*static thread_local*/ bool root_is_locked_;
};
